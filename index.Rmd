...
- Packages
  - Old-timers: sp, rgdal, raster, rgeos, 
  - Whippersnappers: sf, stars
  - landsat
  - SDMtools
  - nlmr
  - landscapetools
...
read_csv("le_lang_year.csv") %>%
  ...
  theme_ipsum() +
  scale_color_manual(values = c("darkgreen","darkgoldenrod","darkblue","darkred","darkgrey"))
```
